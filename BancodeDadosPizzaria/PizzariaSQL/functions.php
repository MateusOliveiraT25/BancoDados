...
<html>
    ...
    <nav class="navtop">
    	<div>
    		<h1> Pizzaria Mateus </h1>
            <a href="index.php"><i class="fas fa-home"></i>Inicio</a>
          <a href="ler_pizza.php"><i class="fas fa-pizza-slice"></i>Pizzas</a>
       <a href="ler_contatos.php"><i class="fas fa-address-book"></i>Contatos</a>
            ...
            <a href="processar_pedido.php"></i>Todos os pedidos</a>
          <a href="ler_horario.php"><i class="fas fa-clock"></i>Horário</a>
